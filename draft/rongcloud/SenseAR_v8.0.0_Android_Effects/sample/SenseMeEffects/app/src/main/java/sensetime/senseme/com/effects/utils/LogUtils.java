...
public class LogUtils {
    ...
    /**
     * Checks to see whether or not a log.txt for the specified tag is loggable at the specified level.
     */
    ...
    /**
     * Send a {@link #VERBOSE} log.txt message.
     *
     * @param tag    Used to identify the source of a log.txt message.  It usually identifies
     *               the class or activity where the log.txt call occurs.
     ...
     * @param tag    Used to identify the source of a log.txt message.  It usually identifies
     *               the class or activity where the log.txt call occurs.
     * @param tr     An exception to log.txt
     * @param format the format string (see {@link java.util.Formatter#format})
     * @param args   the list of arguments passed to the formatter. If there are
     *               more arguments than required by {@code format},
     *               additional arguments are ignored.
    ...
    /**
     * Send a {@link #DEBUG} log.txt message.
     *
     * @param tag    Used to identify the source of a log.txt message.  It usually identifies
     *               the class or activity where the log.txt call occurs.
     * @param format the format string (see {@link java.util.Formatter#format})
    ...
    /**
     * Send a {@link #INFO} log.txt message.
     *
     * @param tag    Used to identify the source of a log.txt message.  It usually identifies
     *               the class or activity where the log.txt call occurs.
     * @param format the format string (see {@link java.util.Formatter#format})
    ...
    /**
     * Send a {@link #WARN} log.txt message.
     *
     * @param tag    Used to identify the source of a log.txt message.  It usually identifies
     *               the class or activity where the log.txt call occurs.
     * @param format the format string (see {@link java.util.Formatter#format})
    ...
    /**
     * Send a {@link #ERROR} log.txt message.
     *
     * @param tag    Used to identify the source of a log.txt message.  It usually identifies
     *               the class or activity where the log.txt call occurs.
     * @param format the format string (see {@link java.util.Formatter#format})
