package sensetime.senseme.com.effects.encoder.mediacodec.filter;
...
import sensetime.senseme.com.effects.encoder.mediacodec.utils.ShaderUtils;
...
public abstract class AFilter {
    ...
    protected final void createProgramByAssetsFile(String vertex, String fragment){
        createProgram(ShaderUtils.uRes(vertex), ShaderUtils.uRes(fragment));
    }
