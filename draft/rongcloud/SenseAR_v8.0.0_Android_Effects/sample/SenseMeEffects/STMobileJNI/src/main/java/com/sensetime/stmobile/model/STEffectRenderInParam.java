...
public class STEffectRenderInParam {
     ...
     */
    public STEffectRenderInParam(long nativeHumanActionResult, STAnimalFaceInfo animalFaceInfo, int rotate, int frontRotate, boolean needMirror, STEffectCustomParam customParam, STEffectTexture texture, STImage image){
     ...
     * @param image 输入图像数据，不需要可传null
     */
    public STEffectRenderInParam(STHumanAction humanAction, STAnimalFaceInfo animalFaceInfo, int rotate, int frontRotate, boolean needMirror, STEffectCustomParam customParam, STEffectTexture texture, STImage image){
